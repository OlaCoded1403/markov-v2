...
**Blob count.** 183 blobs on Sui Mainnet as I write this — 160 from the experiment above, 23 from
...
I counted those 183 by recalling every namespace I know about and summing, because there is no
...
holding 183 encrypted records and no interface that can list them for me. Everything above is
