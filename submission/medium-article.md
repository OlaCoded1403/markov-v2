...
*I ran it for two days, then measured it. At sixty checkpoints, the newest one — the one that IS the current state — came back fiftieth. The prompt reads three.*
...
*Originally published at [olacoded1403.github.io/markov-v2](https://olacoded1403.github.io/markov-v2/). The prompt, the setup guide, the measurement harness and the raw results are all in the [repository](https://github.com/OlaCoded1403/markov-v2).*
